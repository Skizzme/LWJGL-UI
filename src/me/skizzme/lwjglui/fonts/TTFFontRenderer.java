...
public class TTFFontRenderer {
     ...
     */
    private CharacterData[] setup(CharacterData[] characterData, int[] texturesIds, int type) {
        ...
        for (int index = 0; index < characterData.length; index++) {
            ...
            BufferedImage characterImage = new BufferedImage((int) width, (int) height, BufferedImage.TYPE_INT_ARGB);
    ...
    private void createTexture(int textureId, BufferedImage image) {
        ...
        TextureData textureData = new TextureData(textureId, image.getWidth(), image.getHeight(), buffer);
    ...
    public void drawCenteredString(String text, float x, float y, int color) {
        float width = (int) (getWidth(text) / 2d);
